...
# https://github.com/cyberaeonic/Arch-Hyperland-v3aeonic/issues/581
...
install-local-pkgbuild() {
  ...
  # In https://github.com/cyberaeonic/Arch-Hyperland-v3aeonic/issues/823#issuecomment-3394774645 it's suggested to use `sudo pacman -U --noconfirm *.pkg.tar.zst` instead of `makepkg -i`, however it's possible that multiple *.pkg.tar.zst exist, which makes this command not reliable.
