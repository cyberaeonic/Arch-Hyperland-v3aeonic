...
New features (experimental):
      --exp-files             Use yaml-based config for the third step copying files.
                              ...
                              see https://github.com/cyberaeonic/Arch-Hyperland-v3aeonic/issues/2137 for details.
      --via-nix               Use Nix and Home-manager to install dependencies.
                              ...
                              see https://github.com/cyberaeonic/Arch-Hyperland-v3aeonic/issues/1061 for details.
${STY_RST}"
}
