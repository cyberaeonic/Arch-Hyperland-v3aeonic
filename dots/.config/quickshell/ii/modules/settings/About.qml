    ...
    ContentSection {
        ...
        RowLayout {
            ...
            ColumnLayout {
                ...
                StyledText {
                    text: "https://github.com/cyberaeonic/Arch-Hyperland-v3aeonic"
                    font.pixelSize: Appearance.font.pixelSize.normal
                    textFormat: Text.MarkdownText
                    onLinkActivated: (link) => {
                        Qt.openUrlExternally(link)
        ...
        Flow {
            ...
            RippleButtonWithIcon {
                ...
                mainText: Translation.tr("Documentation")
                onClicked: {
                    Qt.openUrlExternally("https://cyber.github.io/Arch-Hyperland-v3aeonic-wiki/en/ii-qs/02usage/")
                }
            }
            RippleButtonWithIcon {
                materialIcon: "adjust"
                ...
                onClicked: {
                    Qt.openUrlExternally("https://github.com/cyberaeonic/Arch-Hyperland-v3aeonic/issues")
                }
            }
            RippleButtonWithIcon {
                materialIcon: "forum"
                ...
                onClicked: {
                    Qt.openUrlExternally("https://github.com/cyberaeonic/Arch-Hyperland-v3aeonic/discussions")
                }
            }
            RippleButtonWithIcon {
                ...
                onClicked: {
                    Qt.openUrlExternally("https://github.com/sponsors/cyber")
                }
            }
